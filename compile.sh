...
gcc Build/main.o Build/ablak.o Build/jatek.o Build/bemenet_es_fajlkezeles.o -o Schatacka `sdl2-config --cflags --libs` -lSDL2_gfx -lSDL2_ttf -lSDL2_image -lSDL2_mixer -Wall -Werror
